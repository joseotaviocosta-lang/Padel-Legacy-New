...
try {
  ...
  assert(firstMigration.data.save_schema_version === 10 && firstMigration.data.metadata.pressJournalistId === 'j12', 'Migration não preservou referência canônica recuperável j12.');
