...
const GROUPS = {
  ...
  career: ['test:training-v2','test:tournament-registration','test:partner-offers','test:partner-day1-gate','test:career-pace','test:injuries','test:calendar-advance','test:tournament-draw-name-collision','test:tournament-confirm-no-skip'],
