...
check('BrandMark não importa o SVG oficial da marca', brandMark.includes("@/assets/brand/logo-mark.svg"));
check('BrandMark não usa import estático `?url` (evita inlining de data-URI quebrado em produção)', brandMark.includes("logo-mark.svg?url"));
...
for (const svgPath of ['src/assets/brand/logo-mark.svg', 'src/assets/brand/logo-horizontal.svg', 'src/assets/brand/logo-monochrome.svg']) {
