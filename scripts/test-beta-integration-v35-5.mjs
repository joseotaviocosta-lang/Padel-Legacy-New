...
const checks = [
  ['ranking usa circuito completo', read('src/pages/Ranking.jsx').includes('for (const athlete of dedupedCircuit)')],
  ...
  ['comunicação abre recurso', read('src/pages/Communications.jsx').includes('selected.metadata?.route')],
