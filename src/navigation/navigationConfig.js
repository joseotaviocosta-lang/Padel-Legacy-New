...
export const NAVIGATION_AREAS = [
  ...
  { id: 'competition', label: 'Competições', description: 'Agenda competitiva, jogos, resultados e ranking.', to: '/competitions', icon: Trophy, items: [
    { to: '/tournaments', icon: Award, label: 'Torneios' }, { to: '/game/calendar', icon: Calendar, label: 'Calendário' }, { to: '/matches', icon: Swords, label: 'Partidas' }, { to: '/replays', icon: Activity, label: 'Replays' }, { to: '/ranking', icon: Trophy, label: 'Ranking' }, { to: '/game/season', icon: BarChart3, label: 'Temporada' }, { to: '/world-tour/live', icon: Radio, label: 'Circuito ao vivo' },
  ]},
