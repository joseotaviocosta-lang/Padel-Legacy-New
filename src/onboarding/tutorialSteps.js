...
export const TUTORIAL_STEPS = [
  ...
  { id: 'style-selected', objectiveType: 'choose_play_style', title: 'Revise seu atleta', explanation: 'Confira nome, mão dominante, lado, estilo, arquétipo, atributos, pontos fortes e pontos a desenvolver antes de confirmar.', route: '/game/missions', actionLabel: 'Revisar atleta', phase: 'Identidade' },
