export function getCareerRecommendations(profile, context = {}) {
  ...
  else if (Number(profile.energy || 0) < 30) add({ id: 'recover-energy', priority: 95, importance: 'recomendada', title: 'Recupere energia', explanation: 'Competir cansado reduz desempenho e aumenta o risco de lesão.', route: '/game/training', actionLabel: 'Planejar dia livre' });
