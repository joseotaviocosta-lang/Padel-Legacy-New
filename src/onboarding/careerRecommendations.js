export function getCareerRecommendations(profile, context = {}) {
  ...
  if (!profile.partner_id) add({ id: 'find-partner', priority: 85, importance: 'importante', title: 'Encontre um parceiro', explanation: profile.tactical_role === 'finalizador' ? 'Procure controle e construção.' : profile.tactical_role === 'controlador' ? 'Procure definição e pressão.' : 'Compare funções, lados e atributos complementares.', route: '/partners', actionLabel: 'Buscar dupla' });
