export const PAGE_INTRODUCTIONS = {
  ...
  '/game/economy': { title: 'Gestão da carreira', description: 'Receitas, despesas, contratos, investimentos e comissão técnica.', purpose: 'Aqui você mantém a carreira sustentável e monta a estrutura profissional que melhora preparação, recuperação e decisões.', tip: 'Na aba Comissão, acompanhe mercado mensal, contratos, satisfação, evolução e relatórios antes de decidir.' },
