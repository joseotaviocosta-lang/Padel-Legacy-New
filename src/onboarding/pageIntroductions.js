export const PAGE_INTRODUCTIONS = {
  ...
  '/game/economy': { title: 'Finanças', description: 'Receitas, despesas, contratos e investimentos.', purpose: 'Manter reserva evita que taxas e salários bloqueiem seus planos.', tip: 'Não comprometa grande parte do saldo no início.' },
