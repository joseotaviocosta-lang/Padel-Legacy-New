...
export default function OnboardingGuide() {
  ...
  return <>
    ...
    <button
      ...
      className="career-help-fab fixed bottom-[calc(5.2rem+env(safe-area-inset-bottom))] left-3 z-50 flex h-11 w-11 min-w-0 shrink-0 items-center justify-center rounded-full border border-primary/30 bg-background p-0 text-primary shadow-xl md:bottom-5 md:left-auto md:right-5"
