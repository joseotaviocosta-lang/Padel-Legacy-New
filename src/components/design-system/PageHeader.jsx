        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex min-w-0 items-start gap-3">
            ...
            <div className="min-w-0">
              {eyebrow && <p className={cn('mb-1 text-[10px] font-extrabold uppercase tracking-[0.18em] text-primary/80', dense && 'hidden md:block')}>{eyebrow}</p>}
              ...
              {description && <p className={cn('mt-1.5 max-w-3xl text-sm leading-relaxed text-muted-foreground', dense && 'hidden md:block')}>{description}</p>}
            </div>
          </div>
          {stats && (
