...
export function StatCard({ label, value, detail, icon: Icon, trend, tone = 'brand', className }) {
    ...
    <div className={cn('pl-stat-card min-w-0 rounded-2xl border p-3.5 sm:p-4', `pl-tone-${tone}`, className)}>
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1 truncate text-xl font-black tracking-[-0.035em] sm:text-2xl">{value}</p>
        </div>
