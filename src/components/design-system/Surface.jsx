...
export function SurfaceHeader({ title, description, action, icon: Icon, className }) {
  return (
    <div className={cn('mb-4 flex min-w-0 items-start justify-between gap-3', className)}>
      <div className="flex min-w-0 items-start gap-2.5">
        ...
        <div className="min-w-0">
          ...
          {description && <p className="mt-0.5 text-xs leading-relaxed text-muted-foreground sm:text-sm">{description}</p>}
        </div>
      </div>
