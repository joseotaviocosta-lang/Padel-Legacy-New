...
export const TUTORIAL_MISSIONS = [
  ...
  { title: 'Crie sua identidade', description: 'Visite Personagem para conhecer a personalização do atleta.', mission_type: 'tutorial', objective_type: 'visit_character', target_count: 1, xp_reward: 25, coins_reward: 50, tutorial_order: 2, tutorial_route: '/character' },
  { title: 'Primeiro treino', description: 'Complete uma sessão de treino para desenvolver um atributo.', mission_type: 'tutorial', objective_type: 'complete_training', target_count: 1, xp_reward: 50, coins_reward: 75, tutorial_order: 3, tutorial_route: '/game/training' },
  { title: 'Estrutura de evolução', description: 'Visite o Centro de Treinamento e conheça suas instalações.', mission_type: 'tutorial', objective_type: 'visit_training_center', target_count: 1, xp_reward: 30, coins_reward: 60, tutorial_order: 4, tutorial_route: '/training-center' },
  { title: 'Encontre sua dupla', description: 'Abra a área de parceiros e conheça as opções de dupla.', mission_type: 'tutorial', objective_type: 'visit_partners', target_count: 1, xp_reward: 40, coins_reward: 75, tutorial_order: 5, tutorial_route: '/partners' },
  { title: 'Conheça o mercado', description: 'Visite a Loja e veja os equipamentos disponíveis.', mission_type: 'tutorial', objective_type: 'visit_shop', target_count: 1, xp_reward: 25, coins_reward: 75, tutorial_order: 6, tutorial_route: '/game/shop' },
  { title: 'Primeira compra', description: 'Compre um item na Loja.', mission_type: 'tutorial', objective_type: 'buy_item', target_count: 1, xp_reward: 50, coins_reward: 100, tutorial_order: 7, tutorial_route: '/game/shop' },
  { title: 'Prepare seu equipamento', description: 'Equipe um item do Inventário.', mission_type: 'tutorial', objective_type: 'equip_item', target_count: 1, xp_reward: 50, coins_reward: 100, tutorial_order: 8, tutorial_route: '/game/inventory' },
  { title: 'Planeje sua semana', description: 'Abra o Calendário da carreira.', mission_type: 'tutorial', objective_type: 'visit_calendar', target_count: 1, xp_reward: 30, coins_reward: 60, tutorial_order: 9, tutorial_route: '/game/calendar' },
  { title: 'O tempo avança', description: 'Avance um dia no calendário da carreira.', mission_type: 'tutorial', objective_type: 'advance_days', target_count: 1, xp_reward: 50, coins_reward: 100, tutorial_order: 10, tutorial_route: '/game/calendar' },
  { title: 'Entre no circuito', description: 'Visite a página de Torneios.', mission_type: 'tutorial', objective_type: 'visit_tournaments', target_count: 1, xp_reward: 35, coins_reward: 75, tutorial_order: 11, tutorial_route: '/tournaments' },
  { title: 'Primeiro torneio', description: 'Participe de um torneio oficial.', mission_type: 'tutorial', objective_type: 'join_tournament', target_count: 1, xp_reward: 100, coins_reward: 150, tutorial_order: 12, tutorial_route: '/tournaments' },
  { title: 'Meça sua evolução', description: 'Visite o Ranking mundial.', mission_type: 'tutorial', objective_type: 'visit_ranking', target_count: 1, xp_reward: 35, coins_reward: 75, tutorial_order: 13, tutorial_route: '/ranking' },
  { title: 'Acompanhe as notícias', description: 'Abra o Jornal e conheça os acontecimentos do circuito.', mission_type: 'tutorial', objective_type: 'visit_journal', target_count: 1, xp_reward: 35, coins_reward: 75, tutorial_order: 14, tutorial_route: '/journal' },
  { title: 'Fale com a imprensa', description: 'Visite a área de Imprensa e conheça as entrevistas.', mission_type: 'tutorial', objective_type: 'visit_press', target_count: 1, xp_reward: 40, coins_reward: 80, tutorial_order: 15, tutorial_route: '/press' },
  { title: 'Administre sua carreira', description: 'Abra a Economia e conheça receitas, despesas e equipe.', mission_type: 'tutorial', objective_type: 'visit_economy', target_count: 1, xp_reward: 50, coins_reward: 100, tutorial_order: 16, tutorial_route: '/game/economy', medal_reward: 'Primeiros Passos' },
];
