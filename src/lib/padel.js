...
const LEGACY_TUTORIAL_MISSIONS = [
  ...
  { title: 'Primeiro treino', description: 'Complete uma sessão de treino para desenvolver um atributo.', mission_type: 'tutorial', objective_type: 'complete_training', target_count: 1, xp_reward: 50, coins_reward: 75, tutorial_order: 5, tutorial_route: APP_ROUTES.TRAINING },
  { title: 'Estrutura de evolução', description: 'Visite o Centro de Treinamento e conheça suas instalações.', mission_type: 'tutorial', objective_type: 'visit_training_center', target_count: 1, xp_reward: 30, coins_reward: 60, tutorial_order: 6, tutorial_route: APP_ROUTES.TRAINING_FACILITIES },
