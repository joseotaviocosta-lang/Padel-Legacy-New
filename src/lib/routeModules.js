export const PAGE_LOADERS = {
  ...
  NavigationHub: () => import('@/pages/NavigationHub'), WorldHub: () => import('@/pages/WorldHub'), Staff: () => import('@/pages/Staff'), Communications: () => import('@/pages/Communications'),
};
...
const ROUTE_MODULES = {
  ...
  '/development': 'NavigationHub', '/team-hub': 'NavigationHub', '/staff': 'Staff', '/communications': 'Communications', '/competitions': 'NavigationHub', '/world': 'WorldHub', '/management': 'NavigationHub',
};
